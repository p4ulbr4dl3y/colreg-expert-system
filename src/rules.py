...
def evaluate_sailing_vessels_rule12(own: Vessel, target: Vessel, wind_dir: float) -> Tuple[VesselRole, Action, List[str]]:
    ...
    if own_starboard_tack != tgt_starboard_tack:
        ...
        if not own_starboard_tack: # Наш галс левый
            explanation.append("наше судно идет левым галсом и должно уступить дорогу судну на правом галсу согласно Правилу 12 (a)(i)")
            return VesselRole.GIVE_WAY, Action.ALTER_COURSE_STARBOARD, explanation
        else:
            explanation.append("наше судно идет правым галсом и имеет преимущество, цель идет левым галсом и должна уступить дорогу согласно Правилу 12 (a)(i)")
        ...
        if pos_own_windward > pos_tgt_windward:
            explanation.append("наше судно находится с наветренной стороны и должно уступить дорогу подветренному судну согласно Правилу 12 (a)(ii)")
            return VesselRole.GIVE_WAY, Action.ALTER_COURSE_STARBOARD, explanation
        else:
            explanation.append("наше судно находится с подветренной стороны и имеет преимущество, наветренное судно-цель должно уступить дорогу согласно Правилу 12 (a)(ii)")
            return VesselRole.STAND_ON, Action.KEEP_COURSE_SPEED, explanation
