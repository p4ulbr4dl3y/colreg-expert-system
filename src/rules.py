...
def evaluate_sailing_vessels_rule12(own: Vessel, target: Vessel, wind_dir: float) -> Tuple[VesselRole, Action, List[str]]:
    ...
    # (согласно МППСС-72, наветренной стороной считается сторона, противоположная той, на которой находится грот)
    ...
    explanation = [
        "Правило 12 для парусных судов: Оба судна идут под парусом.",
